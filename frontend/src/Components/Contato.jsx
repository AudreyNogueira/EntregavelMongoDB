...
const Contato = () => {
    ...
    React.useEffect(async () => {
        const url = "http://localhost:8080/Contato";
...
<div className="col-6 col-md-5">(11)99999-9999</div>
          ...
          <hr/>
            ...
            <form onSubmit={registerComment}>
                ...
                <textarea className="form-control" name="msg" id="msg" value={msg} cols="90" rows="5" placeholder="Deixe aqui sua mensagem" onChange={event=>setMsg(event.target.value)}></textarea><br/>
